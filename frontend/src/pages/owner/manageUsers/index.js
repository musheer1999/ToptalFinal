  ...
  return (
    <PageShell>
      ...
      <div style={{ marginBottom: 14 }}>
        <Banner tone="warning">
          ⚠️ Blocking a user prevents them from placing orders at your restaurant.
        </Banner>
      </div>
      {customers.length === 0 ? (
        <EmptyState
          ...
          body="Customers who order from you will appear here."
        />
      ) : (
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ marginTop: 4 }}>
                    {blocked ? (
                      ...
                      >
                        <span
                          style={{ width: 5, height: 5, borderRadius: 999, background: '#E53E3E' }}
                        />
                        Blocked
                      </span>
                    ) : (
                      ...
                      >
                        <span
                          style={{ width: 5, height: 5, borderRadius: 999, background: '#38A169' }}
                        />
                        Active
                      </span>
                    )}
