  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', maxWidth: 520, width: '100%' }}>
        ...
        <h1 style={{ fontSize: 'clamp(28px, 8vw, 42px)', fontWeight: 800, color: '#1A202C', letterSpacing: -1, margin: '0 0 12px' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Button size="lg" variant="secondary" onClick={() => navigate('/sign-up')}>Create account</Button>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12, marginTop: 48 }}>
          {[
            ...
            <div key={f.label} style={{
              background: 'white', border: '1px solid #E8ECF0', borderRadius: 14,
