...
function RestaurantCard({ restaurant: r }) {
  ...
  return (
    <div
      onClick={() => navigate(`/browse-meals/${r.id}`)}
      style={{
        background: 'white',
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 6px 20px rgba(15,23,42,0.1)';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div style={{ padding: 14 }}>
        <h3 style={{ margin: '0 0 5px', fontSize: 15, fontWeight: 700, color: '#1A202C' }}>
          {r.name}
        </h3>
        <p
          style={{
  ...
  return (
    <PageShell>
      <PageHeader
        ...
        subtitle={`${restaurants.length} kitchens delivering tonight.`}
      />
